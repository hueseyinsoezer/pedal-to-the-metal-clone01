...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.Translate(Vector3.right * Time.deltaTime * turnSpeed);   //Vector3.right equals (1,0,0), this formel means that our vehicle moves (turnSpeed,0,0) per second   
    }
}
